...
- **Private/invite, not public.** Reachability is via a private overlay (Tailscale) —
  not "post your IP for the world."
...
- **Tested bare-internet hosting.** Make port-forwarding (no overlay) a documented, *verified*
  path instead of the provisional one it is today.
