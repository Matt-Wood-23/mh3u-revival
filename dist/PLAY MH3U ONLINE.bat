...
rem --- 1) one-time: create a unique local online identity --------------------
if not exist "%ACCT%" (
    echo(
    echo  [MH3U Online] First run -- creating your unique online identity...
    ...
    echo  [MH3U Online] Identity created ^(NEX PID !PID!^).
)
